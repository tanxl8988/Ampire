...
-(NSArray *)parkingModeMap{
    
    if (!_parkingModeMap) {
        _parkingModeMap = @[@"German",@"English"];
    }
    return _parkingModeMap;
}
...
- (NSArray *)GSensorMap{
    ...
    if (!_GSensorMap) {
        _GSensorMap = @[@"OFF",@"LEVEL4",@"LEVEL2",@"LEVEL0"];
    }
    return _GSensorMap;
}
