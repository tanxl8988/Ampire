...
//                return;
            ...
            NSString *str = [FWVersion substringWithRange:NSMakeRange(10, 3)];
            float ver = [str floatValue];
            if (([FWVersion containsString:@"890"] && ver < 1.29) || ([FWVersion containsString:@"892"] && ver < 1.7)) {
